...
export default function Navigation() {
  ...
  const linkClass = (active) =>
    `rounded-full px-4 py-2 text-label-md transition-all duration-300 ${active
  ...
  return (
    <nav className="fixed top-0 z-50 w-full px-margin-mobile pt-3 md:px-margin-desktop md:pt-5">
      <div
        className={`section-container rounded-2xl border border-white/10 transition-all duration-300 ${scrolled
      ...
      >
        ...
        <div
          className={`md:hidden overflow-hidden transition-[max-height,opacity,transform] duration-300 ease-out ${isMobileOpen
            ...
            <div className="space-y-2">
              {links.map((link) => (
                <Link
                  ...
                  className={`flex items-center justify-between rounded-xl px-4 py-3 text-label-md transition-colors ${isActive(link.to)
