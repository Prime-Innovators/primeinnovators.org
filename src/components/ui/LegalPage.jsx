		...
		<>
			<header className="py-24 md:py-32 section-container">
				<div className="max-w-3xl mx-auto space-y-4">
					<h1 className="text-3xl md:text-4xl font-bold text-on-surface animate-reveal-up">
						{title}
					</h1>
					{subtitle && (
						<p className="text-on-surface-variant animate-reveal-up animation-delay-200">
							{subtitle}
						</p>
					)}
				</div>
