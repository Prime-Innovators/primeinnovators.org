export const ecosystemRoles = [
	{
		...
		subtitle: "Build a verified reputation",
		description:
			"Every PR, issue, and review is tracked, verified by AI, and reflected in your profile. Earn XP, badges, and a verifiable skill graph that speaks louder than any resume.",
		icon: "user",
	},
	{
		title: "For Maintainers",
		subtitle: "Attract motivated contributors",
		description:
			"Submit your project with roadmaps and architecture artifacts. Recruit skilled contributors, receive expert guidance, and access sponsorship infrastructure.",
		icon: "folder",
	},
	{
		title: "For Sponsors",
		subtitle: "Fund with full transparency",
		description:
			"Sponsor contributors, maintainers, or entire projects. Every transaction is publicly recorded on transparent dashboards — full audit trail, complete accountability.",
		icon: "currency",
	},
	{
		...
		description:
			"Filter by verified skills, actual impact scores, and real contribution history. See signals beyond resumes. Hire with confidence.",
		icon: "search",
	},
];
...
export const team = [
	{
		...
		image: "/images/team/mohammad-saeed.jpg",
	...
	},
	{
		...
		image: "/images/team/warisha-shaukat.jpg",
	...
	},
	{
		...
		image: "/images/team/ahmed-habib.jpg",
	...
	},
	{
		...
		image: "/images/team/mohammad-haris.jpg",
