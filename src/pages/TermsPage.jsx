...
export default function TermsPage() {
	...
	return (
		<>
			...
			<LegalPage title="Terms of Service" subtitle="Last updated: May 15, 2026">
				...
				<LegalSection title="Account Registration">
					...
					<p>
						...
						violated these Terms or if your conduct is harmful to the Ecosystem.
					</p>
				</LegalSection>

				<LegalSection title="Acceptable Use">
					<p>
						You agree to use the Ecosystem only for lawful purposes and in
						accordance with these Terms. You agree not to use the Ecosystem:
					</p>
					<ul className="list-disc list-inside space-y-2">
						...
						<li>
							...
							damage, or impair the Ecosystem.
						</li>
					</ul>
				</LegalSection>
				...
				<LegalSection title="User Content">
					<p>
						When you contribute content to the Ecosystem (such as project
						descriptions, comments, or code), you retain all rights to your
					...
					<p>
						...
						content and that your content does not violate these Terms or any
						applicable law.
					</p>
				</LegalSection>
				...
				<LegalSection title="Recruiter Access">
					<p>
				...
				<LegalSection title="Proprietary Rights">
					<p>
						The Ecosystem and its original content, features, and functionality
						are owned by Prime Innovators and are protected by international
				...
				<LegalSection title="Disclaimer">
					...
					<p>
						PRIME INNOVATORS MAKES NO WARRANTY THAT THE ECOSYSTEM WILL BE
						UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE; NOR DOES PRIME
						INNOVATORS MAKE ANY WARRANTY REGARDING THE RESULTS THAT MAY BE
						OBTAINED FROM THE USE OF THE ECOSYSTEM.
					</p>
				</LegalSection>

				<LegalSection title="Limitation of Liability">
					<p>
						IN NO EVENT SHALL PRIME INNOVATORS, NOR ITS DIRECTORS, EMPLOYEES,
						PARTNERS, AGENTS, SUPPLIERS, OR AFFILIATES, BE LIABLE FOR ANY
						INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR EXEMPLARY DAMAGES,
						INCLUDING BUT NOT LIMITED TO DAMAGES FOR LOSS OF PROFITS, GOODWILL,
						USE, DATA, OR OTHER INTANGIBLE LOSSES, EVEN IF PRIME INNOVATORS HAS
				...
				<LegalSection title="Termination">
					<p>
						We may terminate or suspend your account and access to the Ecosystem
						immediately, without prior notice or liability, for any reason
						whatsoever, including without limitation if you breach the Terms.
					</p>
					<p>
						Upon termination, your right to use the Ecosystem will cease
						immediately. If you wish to terminate your account, you may simply
						discontinue using the Ecosystem.
					</p>
				</LegalSection>
				...
				<LegalSection title="Governing Law">
					...
					<p>
						...
						[City, Pakistan if specified, otherwise omit].
					</p>
				</LegalSection>
